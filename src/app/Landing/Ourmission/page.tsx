  ...
  const missionItems = [
    {
      title: "Empower Lives",
      description:
        "Providing the tools and support needed for lasting recovery",
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 px-4 md:px-0">
                  <motion.h3
                    className="font-serif font-[500] text-[#2d2d2d] text-[20px] md:text-[47px]"
                    initial={{ x: -80, opacity: 0 }}
                    animate={
                      isInView ? { x: 0, opacity: 1 } : { x: -80, opacity: 0 }
                    }
                    transition={{
                      duration: 0.8,
                      delay: index * 0.2,
                  ...
                  <motion.p
                    className="[font-family:'Sora',Helvetica] text-[#2c2c2c] text-[14px] md:text-[18px] md:text-lg max-w-md mx-auto md:mx-0"
                    initial={{ x: -80, opacity: 0 }}
                    animate={
                      isInView ? { x: 0, opacity: 1 } : { x: -80, opacity: 0 }
                    }
                ...
                <div className="relative flex-1 flex justify-center md:justify-end px-4 md:px-0">
                  <motion.img
                    src={item.imageSrc}
                    alt={item.title}
                    className="w-full md:max-w-[759px] h-auto object-cover"
                    style={{ scale }}
