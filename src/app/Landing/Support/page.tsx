    ...
    <div className="w-full bg-[#fff] relative ">
      ...
      >
        ...
        <motion.p className="text-center mt-24 font-['Sora'] text-[#2c2c2c] text-[14px] md:text-[18px] max-w-3xl">
          Support from individuals and organizations across Wyoming enables us
          to reach more people in need and expand our services into underserved
          communities. Every contribution, whether time, money, or advocacy,
          builds a stronger foundation for those seeking recovery.
        </motion.p>
