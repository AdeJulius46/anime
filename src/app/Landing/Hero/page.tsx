  ...
  return (
    ...
    >
      ...
      <div className=" flex flex-col items-center justify-center text-center text-white  mt-[390px] md:mt-[390px]  md:px-[45px]  ">
        <motion.h3 className="font-400 text-[16px]  w-64 md:w-full  md:text-[24px] "
      ...
      transition={{
        ...
        <motion.h1 className="text-[70px] mt-[80px] md:mt-[0] leading-none md:leading-[1.5] font-serif  uppercase md:text-[126px] z-10"
